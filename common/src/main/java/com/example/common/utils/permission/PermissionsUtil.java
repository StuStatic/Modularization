...
public class PermissionsUtil {
     ...
     */
    public static void requestPermission(Context context, boolean showTip, PermissionListener listener,String... permission) {
        requestPermission(context, showTip, null, listener, permission);
    }
     ...
     */
    public static void requestPermission(@NonNull Context context, boolean showTip, @Nullable TipInfo tip,
                                         @NonNull PermissionListener listener, @NonNull String[] permission) {
